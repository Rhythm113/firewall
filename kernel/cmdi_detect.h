#ifndef CMDI_DETECT_H
#define CMDI_DETECT_H

/**
 * Analyzes the payload for Command Injection indicators.
 * Looks for shell metacharacters, dangerous binaries, and reverse shell keywords.
 *
 ...
 * @return Cumulative CMDi score (0 to 100). Scores >= 40 represent threat detection.
 */
